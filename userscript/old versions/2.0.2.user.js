...
/*
  ...
  - problemes tribe barons/dukes                   Solved!
...
function menu_extras()
  ...
  if(dom.id('menu_extras'))
    ...
    dom.addEvent(a,'click',function()
      {
      alert('Funktion vorläufig inaktiv!');
      return false;
      dom.id('menu_extras').style.display = 'none';
      dialog_membercolours();
      return false; });
    td.appendChild(a);
    tr.appendChild(td);
    table.appendChild(tr);
    ...
    dom.addEvent(a,'click',function()
      ...
      if(q)
        ...
        if(q)
          {
          GM_setValue('search_active',undefined);
          document.location.reload();
          }
        }
      });
