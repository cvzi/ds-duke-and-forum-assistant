...
const text = {
  'de' : {
    ...
    'label_autoRedirectExternalLinks' : 'Externe Links automatisch weiterleiten',
    ...
    'alert_outdatedSyncCode' : 'Dein Synchronisierungscode funktioniert nicht mehr!\n\nDas automatische Synchronisieren wurde ausgeschaltet.\n\nFrage deinen Stammesführer nach einem neuen Synchronisierungscode.\n\nIm folgenden Fenster erscheinen Informationen zum Fehler.\nDu kannst diese an den Entwickler weiterleiten, wenn du weißt, dass der Synchronisierungscode nicht geändert wurde.',
...
var srcs = {
  ...
  "loader":"http://66mb.de/files/c%201/ajaxloader2.gif"
  };
...
function do_sync(json_data,output_el,frameid) {
  ...
  var data = 'groupid='+synchronizingGroupId+'&userid='+synchronizingUserId+'&key='+escape(synchronizingKey)+'&dataversion='+synchronizingCurrentVersion+'&datajson='+escape(json_data);	
...
function save_dialog_syncSettings()
  ...
  //   synchronizingKey;synchronizingURL;synchronizingUserId;synchronizingGroupId
...
function menu_extras()
  ...
  if(dom.id('menu_extras'))
    ...
    table.style.background = '#f6ecd1 url("http://66mb.de/files/background_footer.png")';	
...
<span style="float:left;margin-top:10px; font-size: smaller; opacity: 0.7;">DS Duke &amp; Forum Assistant (3.0.1)</span>


			<div id="footer_logo"> </div>
				<div style="max-width: 1490px; min-width: 250px;" id="linkContainer">


					<div id="footer_left">


<a id="dukeassistantBar_anchor" name="dukeassistantBar_anchor"></a><a href="#dukeassistantBar_anchor" id="link_menu_extras">Extras</a>
						&nbsp;-&nbsp;
						<a target="_blank" href="http://forum.die-staemme.de/index.php">Forum</a>
						&nbsp;-&nbsp;
						<a target="_blank" href="/help2.php">Hilfe</a>
						&nbsp;-&nbsp;
						<a target="_blank" href="/game.php?village=84292&amp;screen=settings&amp;mode=ticket">Support</a>
					</div>
					<div id="footer_right">
						<a href="/game.php?village=84292&amp;screen=buddies">Freunde</a>					</div>
				</div>
